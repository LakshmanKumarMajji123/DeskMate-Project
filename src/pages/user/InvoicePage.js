...
export const InvoicePage = () => {
    ...
    useEffect(() => {
        const fetchOrderDetails = async () => {
            try {
                const response = await fetch(`http://localhost:8000/invoices?productId=${productId}`);
                if (response.ok) {
                            ...
                            <div className="w-3/5 bg-white shadow-lg">
                                ...
                                <div className="flex justify-between p-4">
                                    <div>
                                        ...
                                        <h6 className="font-bold">Order Date : <span className="text-sm font-medium">{order.invoiceDate} </span></h6>
                                        <h6 className="font-bold">Order ID : <span className="text-sm font-medium"> {order.id} </span></h6>
                                    </div>
                                    <div className="w-40">
                                    ...
                                    <div className="w-40">
                                        <address className="text-sm">
                                            <>
                                                ...
                                                <p><span classNameName="">Status:{order.status}</span></p>
                                                <p><span classNameName="">Method:{order.method}</span></p>
                                            </>
                                        </address>
                                    </div>
                                    <div></div>
                                    ...
                                    <div className="border-b border-gray-200 shadow">
                                        <table className="">
                                                    ...
                                                    <>
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <div className="text-sm text-gray-500">
                                                                ...
                                                                Windows 11 , 3 cpu , 8Gb Ram , 256Gb Storage
                                                            </div>
                                                        </td>
                                                        <td className="px-6 py-4 text-sm text-gray-500">
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-sm font-bold"><b>
                                                    {/* ${order.totals.tax} */}
                                                    2.5%
                                                </b></td>
                                            </tr>
